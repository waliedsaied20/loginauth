    ...
    useEffect(() => {
            ...
            <div className="background ">
                ...
                <form >
                    ...
                    <input type="text"  placeholder="Email or Phone" id="username" required onChange={(e) => setEmail(e.target.value)}/>
                        ...
                        <button className='w-full bg-white text-[#080710]  text-xl font-bold px-8 py-2 rounded ' >SignIn with Google</button>
                        <button className="w-full bg-white text-[#080710]  text-xl font-bold px-8 py-2 rounded  my-5 ">Register</button>
                 
                </div>
          
            </div>
            : <button onClick={loginSuccess} className='text-green-400 text-2xl font-bold bg-gray-500 p-2 rounded'>Signin With google</button>
        } */}
        ...
        <form >
            ...
            <input type="text"  placeholder="Email or Phone" id="username" required onChange={(e) => setEmail(e.target.value)}/>
                ...
                <button onClick={loginSuccess} className='w-full bg-white text-[#080710]  text-xl font-bold px-8 py-2 rounded flex justify-center items-center' >SignIn With <FcGoogle className='text-3xl ml-4'/> </button>
                <button className="w-full bg-white text-[#080710]  text-xl font-bold px-8 py-2 rounded  my-5 ">Register</button>
