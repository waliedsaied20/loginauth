            ...
            <div className="background ">
                ...
                <form>
                    ...
                    <input type="text"  placeholder="Email or Phone" id="username" required />
                        ...
                        <div className='flex '>
                            <button className='bg-white text-[#080710]  text-xl font-bold px-8 py-2 rounded-xl w-1/2 my-8 'onClick={signIn}>Log In</button>
                            <button className="bg-white text-[#080710]  text-xl font-bold px-8 py-2 rounded-xl w-1/2 my-8 ">Register</button>
                        </div>
