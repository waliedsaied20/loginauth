            ...
            <div className="background ">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='flex'>
                        ...
                        <button className='w-2/3 bg-white text-[#080710]  text-xl font-bold px-8 py-2 rounded ' onClick={handleSubmit}>SignIn with Google</button>
                        <button className="w-3/4 bg-white text-[#080710]  text-xl font-bold px-8 py-2 rounded  my-8 mx-2">Register</button>
