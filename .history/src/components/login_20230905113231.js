                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="text"  placeholder="Email or Phone" id="username" required onChange={(e) => setEmail(e.target.value)}/>
                        ...
                        <input type="password" placeholder="Password" id="password" required onChange={(e) => setPassword(e.target.value)}/>
                            ...
                            <button className=' bg-white text-[#080710]  text-xl font-bold px-8 py-2 rounded w-full my-8 mx-2 'onClick={signIn}>Log In</button>
                </form>
                        <button className="w-full bg-white text-[#080710]  text-xl font-bold px-8 py-2 rounded  my-8 mx-2">Register</button>
                        <button className=' bg-white text-[#080710]  text-xl font-bold px-8 py-2 rounded ' onClick={handleSubmit}>SignIn with Google</button>
